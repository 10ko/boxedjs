...
module.exports = {
  compile: (boxedrc) => {
    ...
    Object.keys(pages).forEach((pageKey) => {
      let fragmentdPage = generateFromHTML(pages[pageKey], templates, 0);
    ...
    Object.keys(jsonPages).forEach((pageKey) => {
      ...
      Object.keys(templates).forEach((fragmentKey) => {
        fragmentdPage =
          fragmentdPage.replace(`[[${fragmentKey}]]`, templates[fragmentKey]);
      });
